...
class GiveShotDialog extends StatefulWidget {
  const GiveShotDialog({
    super.key,
    required this.cell,
  ...
  @override
  State<GiveShotDialog> createState() => _GiveShotDialogState();
}

class _GiveShotDialogState extends State<GiveShotDialog> {
